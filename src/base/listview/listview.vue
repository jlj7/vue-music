<template>
  <scroll @scroll="scroll" class="listview" :data="data" ref="listview" :listen-scroll="listenScroll" :probe-type="probeType">
    <ul>
...
export default {
  created () {
    // 以下数据并不需要被vue监听观测变化，所以不用在data里声明，在created里声明即可
    this.touch = {}
  ...
  methods: {
    ...
    onShortcutTouchStart (e) {
      ...
      let firstTouch = e.touches[0] // 获得触碰时手指的位置
    ...
    onShortcutTouchMove (e) {
      ...
      let delta = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT | 0 // '| 0'的作用是向下取整，与Math.floor(num)效果一样
